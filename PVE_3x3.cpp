...
TicRand::TicRand(QWidget *parent) : QWidget(parent)
{
...
void TicRand::paintEvent(QPaintEvent *)
{
    //RYSUJEMY BOARD
...
void TicRand::mousePressEvent(QMouseEvent *idk)
{
...
void TicRand::PlayRand()
{
    //LOSOWY RUCH PC -> NA PODSTAWIE QRandomGenerator
    Move randMove = los.RandPlay(playing.player);
     board.SetArea(randMove.spot, playing.player);
     drawBoard[randMove.spot] = playing.player;
}
